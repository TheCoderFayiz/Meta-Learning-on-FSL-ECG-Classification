...
def main():
    ...
    if args.Model == 'SCNN':
        ...
        if (args.Retrain):
            ...
            X_train, y_train, X_val, y_val = utils.create_supervised_task(['ECG200', 'ECG5000'],  ['ECGFiveDays', 'TwoLeadECG'], '../data/', 187)
        ...
        SCNN_hist = SCNN_model.fit(X_test, y_test,X_test, y_test)
